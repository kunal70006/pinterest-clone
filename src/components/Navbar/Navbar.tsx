...
const Navbar: NextPage<NavbarProps> = ({ toggle, setToggle }) => {
  return (
    <>
      <nav className="lg:h-screen lg:w-60 sm:w-full px-6 shadow-lg lg:flex flex-col items-center mt-8 fixed tracking-wider text-slate-900 bg-white z-50 sm:hidden sm:h-screen">
